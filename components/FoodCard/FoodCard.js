...
function FoodCard() {
  return (
  	...
  	<div className='shadow bg-background-color-light w-64 mx-2 rounded-xl my-6 overflow-hidden cursor-pointer hover:shadow-md transition  hover:-translate-y-1 delay-150'>
  	 <img src='/food5.jpg' className='object-cover h-48 w-full'/>
  	 <div className='p-3'>
  	 	 <h4 className='flex justify-center text-xl text-gray-600 font-bold'>$45</h4>
	  	 <div className='flex justify-between'>
	  	  <h3 className='font-semibold'>Paneer pizza</h3>
	  	  <div>
	  	   <span className='bg-green-500 p-0 text-sm py-0.5 px-1 text-white rounded'>4.6</span>
	  	  </div>	  	  
	  	 </div>
	  	 <p className='text-gray-400 py-1'>Spicy,hot pizz to... </p>		 
